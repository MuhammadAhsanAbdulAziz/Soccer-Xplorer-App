...
public class FavouritePlayerRepository {
    MutableLiveData<List<FavouritePlayerModel>> favplayerlist;
    ...
    public LiveData<List<FavouritePlayerModel>> getFavouritePlayerbyUserId(String id) {
        favplayerlist = new MutableLiveData<>();
        ArrayList<FavouritePlayerModel> data = new ArrayList<FavouritePlayerModel>();
                ...
                for (DataSnapshot ds : snapshot.getChildren()) {
                    {
                        if (ds.child("userId").getValue(String.class).equals(id)) {
                            data.add(new FavouritePlayerModel(
                                    ds.child("favouritePlayerId").getValue(String.class),
                                    ds.child("userId").getValue(String.class),
                                    ds.child("playerId").getValue(String.class)));
                            favplayerlist.setValue(data);
                        }
                    }
                }
            }
